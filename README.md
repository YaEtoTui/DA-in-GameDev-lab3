...
Ход работы:
Для 1 задания я сделал все пригатавления, указанные в видеоматериале. Запустим сцену, проверив работу ML-Agent’a. 
Затем создал 3, 9, 27 копии модели «Плоскость-Сфера-Куб» и запустил симуляцию сцены. На следующих скринах это ясно показано:
